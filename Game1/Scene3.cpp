...
void Scene3::Init()
{
    ...
    OBJECT->AddStructure(new Structure(Concrete, _16x8, Floor), Vector3(108, -24, 0), 90);      // 떨어지는 곳 바닥
    ...
    OBJECT->AddStructure(new Structure(Concrete, _16x8, Floor), Vector3(192, -24, 0), 90);      // 떨어지는 곳 바닥
